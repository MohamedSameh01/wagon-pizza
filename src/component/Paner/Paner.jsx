      ...
      <div className="container">
        <div className="offer__wrapper">
          <div className="offer__content">
            <h2>
              <span className="highlight">Im Wangen's Pizza</span> geniessen Sie
              exzellente Speisen und Getränke in einem entspannten Ambiente. Wir
              vereinen gekonnt die raffinierte italienische Esskultur mit dem
